(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".auctions-products__slider")) new core(".discount__slider", {
                ...
                scrollbar: {
                    el: ".discount__slider .swiper-scrollbar",
                    draggable: true
                },
                on: {}
            });
            if (document.querySelector(".auctions-products__slider")) new core(".auctions-products__slider", {
                ...
                speed: 800,
                scrollbar: {
                    el: ".auctions-products__slider .swiper-scrollbar",
                    draggable: true
                },
                mousewheel: {
                    sensitivity: 4,
                    eventsTarget: ".auctions-products__slider"
                },
                on: {}
            });
        }
